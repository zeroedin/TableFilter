...
function (_Feature) {
  ...
  function AdapterEzEditTable(tf, cfg) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AdapterEzEditTable).call(this, tf, AdapterEzEditTable));
    /**
     * Module description
     * @type {String}
     */
...
function (_Feature) {
  ...
  function ColOps(tf, opts) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ColOps).call(this, tf, ColOps));
    /**
...
function (_Feature) {
  ...
  function ColsVisibility(tf, f) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ColsVisibility).call(this, tf, ColsVisibility)); // Configuration object
...
function (_Feature) {
  ...
  function FiltersVisibility(tf, f) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FiltersVisibility).call(this, tf, FiltersVisibility));
    /**
     * Module name
     * @type {String}
     */
...
function (_Feature) {
  ...
  function AdapterSortableTable(tf, opts) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AdapterSortableTable).call(this, tf, AdapterSortableTable));
    /**
     * Module name
     * @type {String}
     */
      ...
      SortableTable.prototype.initHeader = function (oSortTypes) {
        ...
        for (var i = 0; i < l; i++) {
          ...
          if (stt.sortTypes[i] !== null && stt.sortTypes[i] !== 'None') {
            ...
            img = Object(_dom__WEBPACK_IMPORTED_MODULE_2__["createElm"])('img', ['src', adpt.imgPath + adpt.imgBlank], ['alt', '']);
            c.appendChild(img);
...
AdapterSortableTable.meta = {
  altName: 'sort'
}; //Converters

function ipAddress(value) {
  var vals = value.split('.'); // eslint-disable-next-line no-unused-vars
...
//# sourceMappingURL=tf-0-18be8c0ec8b779545fac.js.map